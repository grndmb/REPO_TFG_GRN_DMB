...
NOMBRE_DIRECTOR VARCHAR (100) NOT NULL COMMENT 'Nombre del director de EFA Moratalaz',
DNI_DIRECTOR VARCHAR (9) NOT NULL COMMENT 'DNI del director de EFA Moratalaz',
...
ID_CONVENIO INT NOT NULL COMMENT 'Identificador de la tabla',
...
CONSTRAINT FK_ANEXAR_CONVENIO FOREIGN KEY (ID_CONVENIO) REFERENCES CONVENIO (ID),
...
INSERT INTO DATOS_EFA (NOMBRE, DIRECCION, CODIGO_POSTAL, TELEFONO, FAX, PAGINA_WEB, NOMBRE_DIRECTOR, DNI_DIRECTOR) VALUES
('EFA MORATALAZ', 'Av. de Andalucía, s/n','13200',926647017,926647140,'https://efa-centro.org/efa-moratalaz/', 'PEDRO JOSÉ YUSTE DEL ÁLAMO', '70347199C');
...
INSERT INTO PROFESOR (DNI_PROFESOR, NOMBRE) VALUES
    ...
    ("76546672G", "Yolanda Garcia Moreno "),
    ("76546671K", "Jesús Santiago Rico"),
    ("76546675J", "David Garcia Efa"),
    ("76546679J", "Miguel Ángel Martin"),
    ("76546678P", "Dani Cuenca Toledo");
...
SELECT * FROM CONVENIO WHERE TIPO_CONVENIO = 'FCT' AND ID_CONVENIO LIKE '%PRIV%';

SELECT * , SUBSTRING(ID_CONVENIO, 11, 3) AS NUMERO_CODIGO FROM CONVENIO WHERE TIPO_CONVENIO = 'FCT' AND ID_CONVENIO LIKE '%PRIV%' ORDER BY NUMERO_CODIGO DESC LIMIT 1;
